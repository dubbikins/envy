...
func TestWalk(t *testing.T) {
	...
	// }
	// <-watcherUpdates
	// if err := tag.WalkContext(t.Context(), tag.ChainContext(tag.UnmarshalTextContext, WalkContextFn), &have); err != nil {
	// 	t.Fatal(err)
	// }
	// if have != want {
...
func TestWatchWalk(t *testing.T) {
	...
	// }
	// <-watcherUpdates
	// if err := tag.WalkContext(context.WithValue(t.Context(), _updatesCtxKey, callback), tag.ChainContext(func (ctx context.Context, n *tag.Node) ( error) {return nil}, WatchWalkContextFn), &have); err != nil {
	// 	t.Fatal(err)
	// }
	// if have != want {
	// 	t.Fatalf("Expected %v, got %v", want, have)
